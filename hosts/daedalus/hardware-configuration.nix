...
# to /etc/nixos/configuration.nix instead.
{
  ...
  fileSystems."/" = {
    device = "/dev/disk/by-uuid/719f7d6e-d1c1-4bde-84af-c994d7db4a2a";
    fsType = "ext4";
  };

  fileSystems."/boot" = {
    device = "/dev/disk/by-uuid/6A0B-034C";
    fsType = "vfat";
  };

  fileSystems."/media/data" = {
    device = "/dev/disk/by-uuid/2b13d130-3b5f-4d9d-8bf6-43ec8f44e8ec";
    fsType = "ext4";
  };
